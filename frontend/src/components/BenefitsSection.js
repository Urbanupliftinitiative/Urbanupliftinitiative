...
const BenefitsSection = () => {
  const benefits = [
    {
      icon: TrendingUp,
      title: "Accelerate revenue uplift through smart amenities"
    },
    {
      icon: DollarSign,
      title: "Increase NOI by reducing operational overhead"
    },
    {
      icon: Shield,
      title: "Protect and future-proof your asset value"
    },
    {
      icon: Building2,
      title: "Differentiate your portfolio in a competitive market"
    }
  ];
