...
const SecuritySection = () => (
  <section data-testid="security-section" className="py-16 md:py-24 px-6">
    <motion.div
    ...
    >
      <div className="px-8 sm:px-12 md:px-16 lg:px-20 py-16 md:py-24 lg:py-32 min-h-[400px] md:min-h-[500px] flex flex-col justify-center">
        <h2
